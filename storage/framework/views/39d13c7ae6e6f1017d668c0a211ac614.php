        ...
        $('#courseForm').on('submit', function (e) {
            ...
            if(errName == false && errFee == false && errCategory == false){
                ...
                $.ajax({
                    method: "POST",
                    dataType: "json",
                    url: "<?php echo e(route('courses.store')); ?>",
                    data: formData,
                    processData: false,
                    contentType: false,
                    beforeSend:function(){
                    ...
                    error: function (xhr) {
                        ...
                        $("#submitBtn").prop("disabled", false).text("Save Course");
                    }
                });
            }
        });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Interview Machine Tests\Ipix Technologies\course-management\resources\views/pages/add_courses.blade.php ENDPATH**/ ?>