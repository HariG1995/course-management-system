        ...
        $('#studentsForm').on('submit', function (e) {
            ...
            if(errName == false && errEmail == false){
                ...
                $.ajax({
                    method: "POST",
                    dataType: "json",
                    url: "<?php echo e(route('students.update', $student->id)); ?>",
                    data: formData,
                    processData: false,
                    contentType: false,
                    beforeSend:function(){
                    ...
                    success: function (response) {
                        if (response.status) {
                            window.location = "<?php echo e(route('students.index')); ?>";
                        }
                    },
                    error: function (xhr) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Interview Machine Tests\Ipix Technologies\course-management\resources\views/pages/edit_students.blade.php ENDPATH**/ ?>