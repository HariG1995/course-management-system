                        ...
                        <tbody>
                            <?php $__currentLoopData = $enrolledStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e(\Carbon\Carbon::parse($student->pivot->enrolled_at)->format('M j, Y g:i A')); ?></td>
                                    <td>
                                        <form action="<?php echo e(route('enrollments.destroy', $student->pivot->id)); ?>" method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?>
    ...
    <div class="card mb-5">
        ...
        <div class="card-body">
            <?php if($availableStudents->count() > 0): ?>
                <form action="<?php echo e(route('enrollments.store', $course->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Interview Machine Tests\Ipix Technologies\course-management\resources\views/pages/enrollment.blade.php ENDPATH**/ ?>